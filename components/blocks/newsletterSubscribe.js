  ...
  return (
    <div className="py-[135px] relative">
      ...
      <div className="container text-center relative text-white">
        <h2 className="text-5xl font-semibold mb-5">{newsletterData.heading}</h2>
        <p className="max-w-[675px] mx-auto text-lg mb-16 font-light">{newsletterData.description}</p>
