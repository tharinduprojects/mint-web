...
const MintHrmNumbers = ({ data: mintHrmNumbers }) => {
  ...
  console.log('mintHrmNumbers', mintHrmNumbers);
  return (
    <div style={{ 'background': `${mintHrmNumbers.bgColor}` }} className="py-20 relative md:min-h-[560px]">
      <Image fill className="w-full h-full object-cover" src={API_BASE_URL + mintHrmNumbers.backDrop.data.attributes.url} alt="" />
