...
const WeAre = async () => {
  ...
  const weAreUrl = API_BASE_URL + '/api/we-ares/?populate[Blocks][populate][0]=backDrop&populate[Blocks][populate][1]=bgImage&populate[Blocks][populate][2]=logos&populate[Blocks][populate][3]=mintNumbers'
  ...
  const mintHrmNumbersData = data.data[0].attributes.Blocks[7]
  return (
    <div>
