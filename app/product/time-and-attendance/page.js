...
const TimeAndAttendance = async () => {
  ...
  const productTimeAndAttandance = API_BASE_URL + '/api/products/6?populate[blocks][populate][0]=backDrop,image,cta,feature,media,sectionImage,accordianItem,backdrop'
