...
const ProductAbsenceAndLeave = async () => {
  ...
  const ProductAbsenceAndLeave = API_BASE_URL + '/api/products/2?populate[blocks][populate][0]=backDrop,image,cta,feature,media,sectionImage,accordianItem,backdrop'
