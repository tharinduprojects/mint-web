...
const KioskEmpowerment = async () => {
  ...
  const kisoskEmpowermentData = API_BASE_URL + '/api/products/18?populate[blocks][populate][0]=backDrop,image,cta,feature,media,sectionImage,accordianItem,backdrop'
