...
const ProductDashboard = async () => {
  ...
  const productDashboardUrl = API_BASE_URL + '/api/products/12?populate[blocks][populate][0]=backDrop,image,cta,feature,media,sectionImage,accordianItem,backdrop'
